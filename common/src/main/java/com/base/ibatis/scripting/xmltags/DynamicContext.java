...
//    }
    ...
    bindings.put(DATABASE_ID_KEY, /*configuration.getDatabaseId()*/"mysql");
  }
  ...
  static class ContextMap extends HashMap<String, Object> {
    ...
    private final String parameterMetaObject;
    private final boolean fallbackParameterObject;

    public ContextMap(String parameterMetaObject, boolean fallbackParameterObject) {
